...
class AuthAPI extends PersonalizationAPI {
  ...
  signup = async (email: string, password: string, phoneNumber: string, firstName: string, lastName: string, userType: string) => {
  ...
  tokenGoogleValidate = async (iToken: IToken, userType: string = "guest") => {
